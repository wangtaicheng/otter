...
public class SubscribeManagerFactory implements ApplicationContextAware {
    ...
    private static final Map<SubscribeType, SubscribeManager> INNER_CONTAINER = OtterMigrateMap
            .makeComputingMap(SubscribeManagerFactory::createSubsrcibeManager);
    ...
    public static SubscribeManager getSubscribeManager(SubscribeType type) {
        ...
        return INNER_CONTAINER.get(type);
    }
