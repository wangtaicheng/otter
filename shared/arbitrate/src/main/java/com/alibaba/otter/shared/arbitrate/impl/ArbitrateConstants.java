...
public interface ArbitrateConstants {
     ...
     */
    String NODE_NID_FORMAT = NODE_NID_ROOT + "/{0}";
     ...
     */
    String NODE_CHANNEL_FORMAT = NODE_CHANNEL_ROOT + "/{0}";
     ...
     * otter的remedy的根节点
     */
    String NODE_REMEDY_ROOT = NODE_PIPELINE_FORMAT + "/remedy";
     ...
     */
    String NODE_PROCESS_FORMAT = NODE_PROCESS_ROOT + "/{2}";

    /**
     * otter的termin信号的根节点
     */
    String NODE_TERMIN_ROOT = NODE_PIPELINE_FORMAT + "/termin";

    /**
     * otter中termin节点的format格式,接受channelId,pipelineId,processId做为参数
     */
    String NODE_TERMIN_FORMAT = NODE_TERMIN_ROOT + "/{2}";
     ...
     * otter的load的lock节点
     */
    String NODE_LOCK_LOAD = "load";

    /**
     * 主导线程的状态节点,为pipeline的子节点
     */
    String NODE_MAINSTEM = "mainstem";

    /**
     * select完成状态的节点,为process的子节点
     */
    String NODE_SELECTED = "selected";

    /**
     * extract完成状态的节点,为process的子节点
     */
    String NODE_EXTRACTED = "extracted";

    /**
     * transform完成状态的节点,为process的子节点
     */
    String NODE_TRANSFORMED = "transformed";

    /**
     * load完成状态的节点,为process的子节点
     */
    String NODE_LOADED = "loaded";

    /**
     * 在logback的配置文件中定义好的按照各个pipeline进行日志文件输出的键值.
     */
    String SPLIT_PIPELINE_LOG_FILE_KEY = "otter";
}
